...
def admin_main_dashboard():
    ...
    # Add token stats for superadmins
...
@app.route('/pixie/api/auth/login', methods=['POST'])
def pixie_api_login():
...
@app.route('/pixie/api/auth/refresh', methods=['POST'])
...
@app.route('/pixie/api/auth/verify', methods=['GET'])
@jwt_required()
